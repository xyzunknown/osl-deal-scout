...
async function fetchCmcCoinDetail(slug) {
  ...
  const parsed = {
    ...
    platforms: (detail.platforms || []).map((platform) => ({
...
<body class="tool-page">
  <header class="topbar">
    <a href="${dashboardHref}" class="topbar-brand" title="返回 Deal Scout">
    ...
    <div class="topbar-actions" style="margin-left:auto;">
      <a href="${dashboardHref}" class="btn">返回 Deal Scout</a>
    </div>
  </header>

  <main class="tool-layout">
    <section class="tool-hero">
      <div class="tool-eyebrow">独立工具</div>
      <h1>币种配置助手</h1>
