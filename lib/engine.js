...
const CHAIN_CONFIG_PRESETS = [
  { match: /\btron\b/i, fullName: 'Tron(TRC20)', shortName: 'Tron', cmcUrl: 'https://coinmarketcap.com/currencies/tron/' },
  { match: /\beth(ereum)?\b/i, fullName: 'Ethereum(ERC20)', shortName: 'Ethereum', cmcUrl: 'https://coinmarketcap.com/currencies/ethereum/' },
  { match: /\bbnb|bsc|binance smart chain\b/i, fullName: 'BNB Smart Chain(BEP20)', shortName: 'BSC', cmcUrl: 'https://coinmarketcap.com/currencies/bnb/' },
  { match: /\bsolana\b/i, fullName: 'Solana', shortName: 'Solana', cmcUrl: 'https://coinmarketcap.com/currencies/solana/' },
  { match: /\bbase\b/i, fullName: 'Base', shortName: 'Base', cmcUrl: 'https://coinmarketcap.com/currencies/base/' },
  { match: /\barbitrum\b/i, fullName: 'Arbitrum', shortName: 'Arbitrum', cmcUrl: 'https://coinmarketcap.com/currencies/arbitrum/' },
  { match: /\boptimism\b/i, fullName: 'Optimism', shortName: 'Optimism', cmcUrl: 'https://coinmarketcap.com/currencies/optimism-ethereum/' },
  { match: /\bpolygon\b/i, fullName: 'Polygon', shortName: 'Polygon', cmcUrl: 'https://coinmarketcap.com/currencies/polygon/' },
  { match: /\bavalanche\b/i, fullName: 'Avalanche C-Chain', shortName: 'Avalanche', cmcUrl: 'https://coinmarketcap.com/currencies/avalanche/' },
  { match: /\bton\b/i, fullName: 'TON', shortName: 'TON', cmcUrl: 'https://coinmarketcap.com/currencies/toncoin/' },
  { match: /\baptos\b/i, fullName: 'Aptos', shortName: 'Aptos', cmcUrl: 'https://coinmarketcap.com/currencies/aptos/' },
  { match: /\bsui\b/i, fullName: 'Sui', shortName: 'Sui', cmcUrl: 'https://coinmarketcap.com/currencies/sui/' },
  { match: /\bzksync\b/i, fullName: 'zkSync Era', shortName: 'zkSync', cmcUrl: 'https://coinmarketcap.com/currencies/zksync/' },
  { match: /\bkaia\b/i, fullName: 'Kaia', shortName: 'Kaia', cmcUrl: 'https://coinmarketcap.com/currencies/kaia/' },
  { match: /\bviction\b/i, fullName: 'Viction', shortName: 'Viction', cmcUrl: 'https://coinmarketcap.com/currencies/viction/' }
];
...
function buildChainConfig(detail) {
  ...
  const rows = platforms.reduce((list, platform) => {
    ...
    if (!preset.cmcUrl) missingFields.push('CMC地址');
...
async function buildIdrPairRow(detail) {
  ...
  const usdtIdrTicker = await fetchIndodaxTicker('usdtidr');
  const usdtIdrRate = Number(usdtIdrTicker && usdtIdrTicker.last || 0);
  const currentPrice = Number(ticker && ticker.last || 0);
  const minOrderAmount = usdtIdrRate > 0 ? PAIR_MIN_NOTIONAL_USD * usdtIdrRate : Number(indodaxPair.tradeMinBaseCurrency || 0);
  const maxOrderAmount = usdtIdrRate > 0 ? PAIR_MAX_NOTIONAL_USD * usdtIdrRate : Number(indodaxPair.tradeMinBaseCurrency || 0) * PAIR_MAX_NOTIONAL_USD;
